...
namespace Temp.Tests
{
  ...
  {
    private const string mConnectionString = "Server=localhost;Database=main;User Id=sa;Password=yourStrong(!)Password;";
    [Test]
    public void TestWithEntityFrameworkOnly()
    {
    ...
    {
      public Context()
      : base(new SqlConnection(mConnectionString), false)
      {
